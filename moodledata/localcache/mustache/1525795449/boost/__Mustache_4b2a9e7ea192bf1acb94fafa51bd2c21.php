...
class __Mustache_4b2a9e7ea192bf1acb94fafa51bd2c21 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE6eee664661cdc7e9161db02e734ffc9($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function sectionE6eee664661cdc7e9161db02e734ffc9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <div class="form-inline m-t-1">
';
...
';
                ...
                $buffer .= '</label>
';
                $buffer .= $indent . '                    <select name="moveafter" id="menumoveafter" class="ignoredirty singleselect select form-control">
';
